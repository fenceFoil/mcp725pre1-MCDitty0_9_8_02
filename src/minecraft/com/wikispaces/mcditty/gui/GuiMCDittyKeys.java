...
import com.wikispaces.mcditty.keyboard.KeyBinding;

public class GuiMCDittyKeys extends GuiScreen {
	...
	public void initGui() {
		// Fetch key bindings
		keyBindings = MCDitty.keypressHandler.getBindings();
	...
	public void drawScreen(int par1, int par2, float par3) {
		...
		for (int i = 0; i < keyButtons.size(); i++) {
			...
			if (keyBindings.get(i).getAction().equals("playBook")
					&& MCDittyConfig.CURRENT_VERSION.equals("0.9.6.02")) {
				labelString += " (Unused)";
			}
